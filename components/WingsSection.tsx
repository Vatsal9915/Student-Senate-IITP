    ...
    <div className=' bg-blue-50 p-8 lg:p-16 pt-20 rounded-lg  flex flex-col items-center justify-center'>
        ...
        <div className="flex flex-col gap-8 justify-center mt-20 lg:flex-row  items-center w-full">
            ...
            <div className='flex flex-col gap-6'>
              ...
              {/* back */}
              <div className="absolute left-0 bottom-0 w-full h-full bg-[#453CD5] shadow-lg p-10 flex flex-col items-start justify-center transition-all duration-500 scale-y-0 origin-bottom opacity-0 group-hover:scale-y-100 group-hover:opacity-100 z-20 text-left">
