  ...
  return (
    <div className=' bg-blue-50 p-8 lg:p-16 pt-20 rounded-lg shadow-lg flex flex-col items-center justify-center'>
        ...
        <div className='flex gap-10 mt-20'>
            {/* DISHA */}
            <div className="relative w-96 h-96 max-w-xs mx-auto group border-b-4 border-[#453CD5] overflow-hidden">
            {/* front */}
            <div className="bg-white shadow-lg p-10 flex flex-col items-center justify-between transition-all duration-500 z-10 w-full h-full">
                ...
                <h2 className="text-4xl font-semibold text-gray-800">DISHA- <span className='text-xl font-semibold text-gray-800 block mt-2'>CAREER GROWTH AND TRAINING CELL</span></h2>
            </div>
            {/* back */}
            <div className="absolute left-0 bottom-0 w-full h-full bg-[#453CD5] shadow-lg p-10 flex flex-col items-center transition-all duration-500 scale-y-0 origin-bottom opacity-0 group-hover:scale-y-100 group-hover:opacity-100 z-20">
            ...
            <div className="bg-white shadow-lg p-10 flex flex-col items-center justify-between transition-all duration-500 z-10 w-full h-full">
                <h1 className="text-lg tracking-widest font-semibold text-[#453CD5] mb-4">COUNCIL</h1>
                <h2 className="text-4xl font-semibold text-gray-800">ARTHNITI- <span className='text-xl font-semibold text-gray-800 block mt-2'>ENTREPRENEURSHIP AND INNOVATION CELL</span></h2>
            </div>
            {/* back */}
            <div className="absolute left-0 bottom-0 w-full h-full bg-[#453CD5] shadow-lg p-10 flex flex-col items-center transition-all duration-500 scale-y-0 origin-bottom opacity-0 group-hover:scale-y-100 group-hover:opacity-100 z-20">
                <h1 className="text-lg tracking-widest font-semibold text-white mb-4">COUNCIL</h1>
